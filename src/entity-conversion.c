...
{
  /*----------------------------------------------------------------------
  ; The following table is sorted via the C locale.  This is okay, as that
  ; locale for collation is set at the beginning of the program.
  ;
  ; This list was obtained from https://www.w3.org/TR/html5/entities.json
  ; and massaged into this format.
  ;-----------------------------------------------------------------------*/
  
  static struct entity_conv const table[] =
  {
    { "AElig"                           ,    198 },
    { "AMP"                             ,     38 },
    { "Aacute"                          ,    193 },
  ...
  while(*s)
  {
    if (*s == '&')
    {
      ...
      *p = '\0';
      ...
      pe = bsearch(entity,table,sizeof(table)/sizeof(table[0]),sizeof(struct entity_conv),entity_cmp);
