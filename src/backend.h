...
typedef struct template
{
  ...
  char const *file;
  size_t       items;
  int        (*pagegen)(struct template const *,FILE *,Blog const);
  bool         reverse;
  bool         fullurl;
} template__t;
...
extern int pagegen_items  (template__t const *,FILE *,Blog const);
extern int pagegen_days   (template__t const *,FILE *,Blog const);
